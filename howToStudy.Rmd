...
- **Strategy #1** – *Attend each lecture and discussion section, and do all of the required readings."*\
Attendance and completion of the assignments is an important prerequisite for learning the material.

- **Strategy #2** – *Take good notes*.\
...
It is also important to take notes during *discussion sections* and while doing the readings.
Taking notes will not only facilitate active learning, but also will be useful when preparing for exams.

- **Strategy #3** – *Pay close attention to things talked about more than once.*\
...
- **Strategy #4** – *When you read an article or review a lecture, ask yourself: "What are the main messages Dr. Petersen wants us to hear?"*\
...
- **Strategy #5** – *Pay attention to the examples Dr. Petersen and the TAs use in lecture and section.*\
...
- **Strategy #6** – *Focus on understanding the concepts, not just memorizing the details.*\
