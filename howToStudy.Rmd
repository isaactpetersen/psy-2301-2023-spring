...
<u>Pay attention to the examples Dr. Petersen and the TAs use in lecture and section.</u>
...
First, use <u>Quizlet</u> to test your ability to provide definitions for key concepts.
We have created Quizlet programs for each lecture, which you can access through the "Quizlet" folder of the "Files" tab in ICON.
Note that you can use Quizlet yourself as a strategy for organizing your self-learning, too.
...
This study method is more challenging than Match. Flashcards evaluates your ability to recall the correct definition for each term.
This study method is the most challenging.

Second, <u>complete all example study questions</u> for each exam, which you can find in the "Example Study Questions" folder of the "Files" tab in ICON.
